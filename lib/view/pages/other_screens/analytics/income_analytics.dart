...
import 'package:expense_manager/view_model/analytics/income_analytics_view_model.dart';
...
class _IncomeAnalyticsState extends State<IncomeAnalytics> {
  ...
  final IncomeAnalyticsViewModel _viewModel = IncomeAnalyticsViewModel();

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    _viewModel.calculateIncomeWithTrans(months[m], year.toString());
    _viewModel.calculateIncomeWithType(months[m], year.toString());
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Center(
                  child: Text(
                    '${months[m]} $year Month Income Analytics',
                ...
                Container(
                  ...
                  height: ResponsiveBreakpoints.of(context).isDesktop
                      ...
                      : ResponsiveBreakpoints.of(context).screenHeight * 0.8,
                  child: _viewModel.showPieIncomeType(
                ...
                Container(
                  ...
                  height: ResponsiveBreakpoints.of(context).isDesktop
                      ...
                      ? ResponsiveBreakpoints.of(context).screenHeight * 0.8
                      : ResponsiveBreakpoints.of(context).screenHeight * 0.8,
                  child: _viewModel.showPieIncomeTrans(
                      context, months[m], year.toString()),
                ),
                const SizedBox(
                  height: 10.0,
